...
beautiful.init("/home/simonabj/.config/awesome/nord/theme.lua")
...
local widget_fg = theme.fg_normal
local widget_bg = theme.bg_widget
...
local storage_home = awful.widget.watch('/home/simonabj/.local/scripts/disk-usage.sh', 60, function(self, stdout)
  st_home = stdout
...
local br, br_signal = awful.widget.watch('/home/simonabj/.local/scripts/brightness-bar.sh', 60, function(self, stdout)
...
local vo, vo_signal = awful.widget.watch('/home/simonabj/.local/scripts/volume-bar.sh', 60, function(self, stdout)
  local vol = stdout
...
awful.key({ modkey, }, "s", hotkeys_popup.show_help,
  ...
  awful.key({ modkey, "Shift" }, "s",
    function() awful.spawn("scrot -s -q 100 /home/simonabj/Pictures/Screenshots/%Y-%m-%d_$wx$h.png") end,
  ...
  -- Rofi Power Menu
  awful.key({ modkey, "Shift" }, "p", function() awful.spawn("/home/simonabj/.local/scripts/power_menu.sh") end,
  ...
  awful.key({}, "XF86MonBrightnessUp",
    function()
      ...
      awful.spawn("/home/simonabj/.local/scripts/brightness-up.sh")
      awful.spawn("/home/simonabj/.local/scripts/brightness-bar.sh", function(self, brightness)
        update_brightness_widget(brightness)
      end)
  ...
  awful.key({}, "XF86MonBrightnessDown",
    function()
      --local brightness = [[/home/sv/scripts/brightness-bar.sh]]
      awful.spawn("/home/simonabj/.local/scripts/brightness-down.sh")
      awful.spawn("/home/simonabj/.local/scripts/brightness-bar.sh", function(self, brightness)
        update_brightness_widget(brightness)
      end)
      br_signal:emit_signal("timeout")
  ...
  awful.key({}, "XF86AudioRaiseVolume",
    function()
      ...
      awful.spawn("/home/simonabj/.local/scripts/volume-up.sh")
...
-- client.connect_signal("focus", function(c) c.border_color = "#313244" end)
-- client.connect_signal("unfocus", function(c) c.border_color = "#b4befe" end)
