...
mymainmenu = awful.menu({
    items = {
        ...
        { "Thunar",   function() awful.spawn.with_shell("thunar") end },
...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    local layouts = { l.tile.right, l.tile.right, l.tile.right, l.tile.right, l.tile.right }
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey }, ".", function()
            awful.spawn.with_shell("/opt/enpass/Enpass showassistant")
        end,
        { description = "Show enpass", group = "launcher" }),
...
ruled.client.connect_signal("request::rules", function()
    ...
    ruled.client.append_rule {
        ...
        rule_any   = {
            ...
            class    = {
                ...
                "Tor Browser", "Wpa_gui", "veromix", "xtightvncviewer", "Enpass", "PulseAudio Volume Controler"
            },
    ...
    -- Plasma based rules
    ruled.client.append_rule { rule = { name = "Desktop.*Plasma" }, properties = { floating = true, border_width = 0, shape = gears.shape.rectangle } }
    ruled.client.append_rule { rule = { name = "Plasma" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "plasmashell" }, properties = { floating = true } }
    ruled.client.append_rule { rule = { instance = "Plasma" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "plasma-desktop" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "win7" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "krunner" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "Kmix" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "Klipper" }, properties = { floating = true, border_width = 0 } }
    ruled.client.append_rule { rule = { instance = "Plasmoidviewer" }, properties = { floating = true, border_width = 0 } }
...
client.connect_signal("manage", function(c)
    if (c.type == "dock" and c.name == "Plasma") -- Plasma Panel
        or c.type == "desktop" then              -- Plasma Desktop
        -- naughty.notify({ title = "Floating", text = "Created " .. c.type .. " for " .. c.name .. "." })
        c.focusable = false
...
awful.screen.connect_for_each_screen(function(s)
    -- Setup screen configuration here
end)
...
-- awful.spawn.with_shell("feh --no-fehbg --bg-fill ~/Pictures/Wallpapers/111387927_p0.png")
